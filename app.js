// Unsolved --> Task-22, Task-35, Task-36, Task-39,
...
// Task-31: Find the first employee in the "Marketing" department.
// Solution-31:
/* const departments = [
  { id: 1, name: "HR" },
  { id: 2, name: "Engineering" },
...
const marketingDepartment = departments.find((department) => {
  return department.name === "Marketing";
});

const marketingDepartmentEmployee = employees.find((employee) => {
  return employee.departmentId === marketingDepartment.id;
});
console.log(marketingDepartmentEmployee); */

// Task-32: Check if all employees earn more than 4000.
// Solution-32:
/* const employees = [
  { id: 1, name: "Alice", departmentId: 1, salary: 5000 },
  { id: 2, name: "Bob", departmentId: 2, salary: 7000 },
...
const employeesEarnMoreThanFourThousand = employees.every((employee) => {
  return employee.salary > 4000;
});
console.log(employeesEarnMoreThanFourThousand); */

// Task-33: Find the last employee in the "HR" department.
// Solution-33:
/* const departments = [
  { id: 1, name: "HR" },
  { id: 2, name: "Engineering" },
...
// Task-34: Verify if all employees belong to a department listed in the departments array.
// Solution-34:
/* const employees = [
  { id: 1, name: "Alice", departmentId: 1, salary: 5000 },
  { id: 2, name: "Bob", departmentId: 2, salary: 7000 },
...
const departmentId = departments.map((department) => department.id);
const allEmployeesBelongToADepartment = employees.every((employee) => {
  return departmentId.includes(employee.departmentId);
});
console.log(
  "All employees belong to a department",
  allEmployeesBelongToADepartment
); */

// Task-35: Log each employee's name and department name to the console.
// Solution-35:

// Task-36: Extract all employee skill names into a single array.
// Solution-36:

// Task-37: Increment each employee's salary by 10%.
// Solution-37:
/* const employees = [
  { id: 1, name: "Alice", departmentId: 1, salary: 5000 },
  { id: 2, name: "Bob", departmentId: 2, salary: 7000 },
...
const TenPercentIncrementEmployeesSalary = employees.map((employee) => {
  const tenPercentSalary = (employee.salary * 10) / 100;
  employee["salary"] = tenPercentSalary + employee.salary;
  return employee;
});
console.log(TenPercentIncrementEmployeesSalary); */

// Task-38: Assume each employee can have multiple skills. Create an array of employee skills and flatten them. Example: [{name: "Alice", skills: ["Excel", "Management"]}, ...].
// Solution-38:
/* const employees = [
  {
    id: 1,
  ...
  },
  {
    ...
    departmentId: 4,
    salary: 7200,
    skills: ["Finance", "Risk Management"],
  },
  {
    id: 9,
    name: "Ian",
...
// Task-39: Find the total salary of all employees working in the "Engineering" department.
// Solution-39:

// Task-40: Check if there is any department where all employees earn more than 5000.
// Solution-40:
